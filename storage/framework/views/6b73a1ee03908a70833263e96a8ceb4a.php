<?php $__env->startSection('title', 'Dashboard Pimpinan'); ?>
...
<div class="row">
    <div class="col-md-4 mb-3"><div class="stat-card"><span class="stat-icon"><i class="fas fa-users"></i></span><div class="stat-value"><?php echo e($total_pegawai); ?></div><p class="stat-label">Pegawai</p></div></div>
    <div class="col-md-4 mb-3"><div class="stat-card"><span class="stat-icon"><i class="fas fa-fingerprint"></i></span><div class="stat-value"><?php echo e($total_absensi); ?></div><p class="stat-label">Total Rekam Absensi</p></div></div>
    <div class="col-md-4 mb-3"><div class="stat-card"><span class="stat-icon"><i class="fas fa-paper-plane"></i></span><div class="stat-value"><?php echo e($total_pengajuan); ?></div><p class="stat-label">Total Pengajuan</p></div></div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\absensirailwayupdate\resources\views/dashboard/pimpinan.blade.php ENDPATH**/ ?>